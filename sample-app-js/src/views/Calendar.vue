...
export default defineComponent({
  ...
  setup(props, context) {
    const state = reactive({
      ...
      // 選択したイベント
      selectedEvent: null,
      // イベント登録／編集ダイアログを表示するかどうか
      isOpenEventDialog: false,
      // 登録／更新対象の新しいイベントの情報
      newEvent: null,
      // イベント開始日付を選択する'v-date-picker'を表示するかどうか
      isOpenStartDatePicker: false,
      // 'v-date-picker'で選択したイベント開始日付
      startDate: null,
      // イベント開始時刻を選択する'v-date-picker'を表示するかどうか
      isOpenStartTimePicker: false,
      // 'v-date-picker'で選択したイベント開始時刻
      startTime: null,
      // イベント終了日付を選択する'v-date-picker'を表示するかどうか
      isOpenEndDatePicker: false,
      // 'v-date-picker'で選択したイベント終了日付
      endDate: null,
      // イベント終了時刻を選択する'v-date-picker'を表示するかどうか
      isOpenEndTimePicker: false,
      // 'v-date-picker'で選択したイベント終了時刻
      endTime: null,
